...
When("I fill in the sign up form") do
    click_link 'Sign up'
    fill_in 'user_email', :with => 'f.torrestristao@yahoo.com.br'
    fill_in 'user_password', :with => 'senha@123'
    fill_in 'user_password_confirmation', :with => 'senha@123'

    click_button 'Sign up'
end

When("I confirm the email") do
    open_email('f.torrestristao@yahoo.com.br')
